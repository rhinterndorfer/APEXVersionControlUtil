...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(42436830359217676553)
,p_plugin_type=>'DYNAMIC ACTION'
,p_name=>'COM.EPORTELA.NUMBERFIELD'
,p_display_name=>'Number Field'
,p_category=>'EXECUTE'
,p_supported_ui_types=>'DESKTOP'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('DYNAMIC ACTION','COM.EPORTELA.NUMBERFIELD'),'')
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(42571948818180018925)
,p_plugin_id=>wwv_flow_api.id(42436830359217676553)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(42573356135443021855)
,p_plugin_id=>wwv_flow_api.id(42436830359217676553)
,p_attribute_scope=>'COMPONENT'
...
,p_supported_ui_types=>'DESKTOP:JQM_SMARTPHONE'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(42571948818180018925)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(42574140083953024257)
,p_plugin_id=>wwv_flow_api.id(42436830359217676553)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(43290104156148191324)
,p_plugin_id=>wwv_flow_api.id(42436830359217676553)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(44674324093311913544)
,p_plugin_id=>wwv_flow_api.id(42436830359217676553)
