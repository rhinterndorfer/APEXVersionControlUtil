-- Generated with
-- Oracle APEX Version Control Util
-- Version: 0.1
-- Source: https://github.com/rhinterndorfer/APEXVersionControlUtil
...
@@application/shared_components/navigation/lists/badgetest.sql
@@application/shared_components/files/app_icon_svg.sql
@@application/shared_components/files/app_icon_css.sql
@@application/shared_components/files/15844038_png.sql
@@application/shared_components/files/favicon_ico.sql
@@application/shared_components/files/img_da_menu_jpg.sql
@@application/plugin_settings.sql
@@application/shared_components/security/authorizations/administration_rights.sql
@@application/shared_components/security/authorizations/componentdebug2.sql
@@application/shared_components/navigation/navigation_bar.sql
@@application/shared_components/logic/application_items/title.sql
@@application/shared_components/logic/application_computations/title.sql
...
@@application/shared_components/plugins/dynamic_action/com_eportela_numberfield.sql
@@application/shared_components/plugins/dynamic_action/at_rammelhof_client_side_pdf.sql
@@application/shared_components/plugins/dynamic_action/at_rammelhof_savedreportbutton.sql
